...
const (
	...
	ConfigDisplayHomeVersion                 = "home_version"                   // 首页版本
...
func (m *DBModel) initConfig() (err error) {
	...
	cfgs := []Config{
		...
		{Category: ConfigCategorySystem, Name: ConfigSystemRegistrerBackground, ColNum: 12, Label: "注册页背景图", Value: "", Placeholder: "请上传一张图片作为注册页背景图", InputType: InputTypeImage, Sort: 62, Options: ""},
		{Category: ConfigCategorySystem, Name: ConfigSystemLoginBackground, ColNum: 12, Label: "登录页背景图", Value: "", Placeholder: "请上传一张图片作为登录页背景图", InputType: InputTypeImage, Sort: 63, Options: ""},
		{Category: ConfigCategorySystem, Name: ConfigSystemSecIcp, Label: "公网安备", ColNum: 12, Value: "", Placeholder: "请输入您网站的公网安备备案号", InputType: InputTypeText, Sort: 68, Options: ""},
		{Category: ConfigCategorySystem, Name: ConfigSystemIcp, Label: "网站备案号", ColNum: 12, Value: "", Placeholder: "请输入您网站的备案号", InputType: InputTypeText, Sort: 69, Options: ""},
		{Category: ConfigCategorySystem, Name: ConfigSystemCopyrightStartYear, ColNum: 24, Label: "版权起始年", Value: "2019", Placeholder: "请输入您网站版权起始年，如：2019，则前台会显示如 ©2019 - 20xx 的字样", InputType: InputTypeText, Sort: 80, Options: ""},
		{Category: ConfigCategorySystem, Name: ConfigSystemAnalytics, ColNum: 24, Label: "网站统计代码", Value: "", Placeholder: "请输入您网站的统计代码，当前只支持百度统计", InputType: InputTypeTextarea, Sort: 90, Options: ""},
		...
		// 安全配置项
		{Category: ConfigCategorySecurity, Name: ConfigSecurityMaxDocumentSize, ColNum: 24, Label: "最大文档大小(MB)", Value: "50", Placeholder: "允许用户上传的最大文档大小，默认为50，即50MB。配置时仍需配置反向代理服务所允许传输的最大大小，如nginx的client_max_body_size值！", InputType: InputTypeNumber, Sort: 1, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityCommentInterval, ColNum: 24, Label: "评论时间间隔", Value: "10", Placeholder: "用户评论时间间隔，单位为秒。0表示不限制。", InputType: InputTypeNumber, Sort: 2, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityDocumentRelatedDuration, ColNum: 24, Label: "文档的【相关文档】有效期", Value: "7", Placeholder: "文档的相关联文档的有效期，默认为7，即7天，0或小于0，表示不开启相关文档功能", InputType: InputTypeNumber, Sort: 15, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityAttachmentRetentionMinute, ColNum: 24, Label: "从回收站清除的文档文件保留时长", Value: "1440", Placeholder: "单位为分钟，默认为1440，即24小时。文档被从回收站清除之后，文档文件并未真正删除，用以规避操作失误的情况。设为 0 则表示即时删除文档文件，用以释放存储空间。", InputType: InputTypeNumber, Sort: 16, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecuritySearchRecordRetentionDays, ColNum: 12, Label: "搜索记录保留天数", Value: "7", Placeholder: "单位为天，默认为7，即7天。0表示不记录用户搜索记录。", InputType: InputTypeNumber, Sort: 17, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityDocumentAllowedExt, ColNum: 12, Label: "允许上传的文档类型", Value: "", Placeholder: "留空表示允许程序所支持的全部文档类型", InputType: InputTypeSelectMulti, Sort: 17, Options: strings.Join(filetil.GetDocumentExts(), "\n")},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityIsClose, ColNum: 8, Label: "是否关闭网站", Value: "false", Placeholder: "请选择是否关闭网站", InputType: InputTypeSwitch, Sort: 160, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityCloseStatement, ColNum: 24, Label: "闭站说明", Value: closeStatement, Placeholder: "关闭网站后，页面提示内容（支持HTML）", InputType: InputTypeTextarea, Sort: 170, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityEnableRegister, ColNum: 8, Label: "是否允许注册", Value: "true", Placeholder: "请选择是否允许用户注册", InputType: InputTypeSwitch, Sort: 18, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityLoginRequired, ColNum: 8, Label: "是否登录才能访问", Value: "false", Placeholder: "用户是否登录了才能访问", InputType: InputTypeSwitch, Sort: 18, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityEnableCaptchaLogin, ColNum: 8, Label: "是否开启登录验证码", Value: "true", Placeholder: "请选择是否开启登录验证码", InputType: InputTypeSwitch, Sort: 19, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityEnableCaptchaRegister, ColNum: 8, Label: "是否开启注册验证码", Value: "true", Placeholder: "请选择是否开启注册验证码", InputType: InputTypeSwitch, Sort: 20, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityEnableCaptchaComment, ColNum: 8, Label: "是否开启评论验证码", Value: "true", Placeholder: "请选择是否开启评论验证码", InputType: InputTypeSwitch, Sort: 21, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityEnableCaptchaFindPassword, ColNum: 8, Label: "是否开启找回密码验证码", Value: "true", Placeholder: "请选择是否开启找回密码验证码", InputType: InputTypeSwitch, Sort: 22, Options: ""},
		{Category: ConfigCategorySecurity, Name: ConfigSecurityEnableVerifyRegisterEmail, ColNum: 8, Label: "是否开启注册邮箱验证", Value: "false", Placeholder: "用户注册时是否需要验证邮箱", InputType: InputTypeSwitch, Sort: 50, Options: ""},
		...
		// 转换配置项
		{Category: ConfigCategoryConverter, Name: ConfigConverterMaxPreviewPercent, ColNum: 24, Label: "最大预览页数百分比", Value: "100", Placeholder: "百分比数值，填1~100，与，0和100均表示不限制。与【最大阅览页数】一起，取两者中的最小值", InputType: InputTypeNumber, Sort: -1, Options: ""},
		{Category: ConfigCategoryConverter, Name: ConfigConverterMaxPreview, ColNum: 12, Label: "最大预览页数", Value: "12", Placeholder: "文档允许的最大预览页数，0表示不限制", InputType: InputTypeNumber, Sort: 0, Options: ""},
		{Category: ConfigCategoryConverter, Name: ConfigConverterTimeout, ColNum: 12, Label: "转换超时(分钟)", Value: "30", Placeholder: "文档转换超时时间，默认为30分钟", InputType: InputTypeNumber, Sort: 20, Options: ""},
		{Category: ConfigCategoryConverter, Name: ConfigConverterExtension, ColNum: 12, Label: "预览格式", Value: "webp", Placeholder: "将文档转为特定格式以供预览", InputType: InputTypeSelect, Sort: 30, Options: "svg:SVG\njpg:JPEG\npng:PNG\nwebp:WEBP"},
		{Category: ConfigCategoryConverter, Name: ConfigConverterEnableConvertRepeatedDocument, ColNum: 12, Label: "是否转换重复文档", Value: "false", Placeholder: "对于已转换过的文档，再次被上传时是否再转换一次", InputType: InputTypeSwitch, Sort: 31, Options: ""},
		{Category: ConfigCategoryConverter, Name: ConfigConverterEnableGZIP, ColNum: 24, Label: "是否启用GZIP压缩", Value: "true", Placeholder: "是否对文档SVG预览文件启用GZIP压缩，启用后转换效率会【稍微】下降，但相对直接的SVG文件减少75%的存储空间", InputType: InputTypeSwitch, Sort: 40, Options: ""},
		{Category: ConfigCategoryConverter, Name: ConfigConverterEnableSVGO, ColNum: 24, Label: "是否启用SVGO", Value: "false", Placeholder: "是否对文档SVG预览文件启用SVGO压缩，启用后转换效率会【明显】下降，但相对直接的SVG文件减少50%左右的存储空间", InputType: InputTypeSwitch, Sort: 50, Options: ""},

		// 下载配置
		{Category: ConfigCategoryDownload, Name: ConfigDownloadEnableGuestDownload, ColNum: 12, Label: "是否允许游客下载", Value: "false", Placeholder: "启用之后，未登录用户可以下载免费文档", InputType: InputTypeSwitch, Sort: 10, Options: ""},
		{Category: ConfigCategoryDownload, Name: ConfigDownloadFreeDownloadDuration, ColNum: 12, Label: "购买文档后多少天内允许免费重复下载", Value: "0", Placeholder: "0表示再次下载仍需购买，大于0表示指定多少天内有效", InputType: InputTypeNumber, Sort: 20, Options: ""},
		{Category: ConfigCategoryDownload, Name: ConfigDownloadUrlDuration, ColNum: 12, Label: "下载链接有效时长(秒)", Value: "60", Placeholder: "生成文档下载链接后多少秒之后链接失效", InputType: InputTypeNumber, Sort: 30, Options: ""},
		{Category: ConfigCategoryDownload, Name: ConfigDownloadTimesEveryDay, ColNum: 12, Label: "允许登录用户每天下载次数", Value: "10", Placeholder: "允许登录用户每天下载次数，0表示不允许下载", InputType: InputTypeNumber, Sort: 40, Options: ""},
		{Category: ConfigCategoryDownload, Name: ConfigDownloadTimesEveryIP, ColNum: 12, Label: "允许每个IP每天下载次数", Value: "10", Placeholder: "允许每个IP每天下载的次数，0表示不允许下载（针对所有用户）", InputType: InputTypeNumber, Sort: 41, Options: ""},
		...
		{Category: ConfigCategoryScore, Name: ConfigScoreUploadDocument, ColNum: 8, Label: "上传文档", Value: "5", Placeholder: "上传一篇文档可获得的积分", InputType: InputTypeNumber, Sort: 30, Options: ""},
		{Category: ConfigCategoryScore, Name: ConfigScoreUploadDocumentLimit, ColNum: 16, Label: "每日上传文档奖励次数", Value: "1", Placeholder: "每天最多可以获得多少次文档上传奖励，0表示无奖励。", InputType: InputTypeNumber, Sort: 40, Options: ""},
		{Category: ConfigCategoryScore, Name: ConfigScoreDocumentCollected, ColNum: 8, Label: "文档被收藏", Value: "1", Placeholder: "上传的文档被收藏后获得的积分", InputType: InputTypeNumber, Sort: 50, Options: ""},
		{Category: ConfigCategoryScore, Name: ConfigScoreDocumentCollectedLimit, ColNum: 16, Label: "每日文档被收藏奖励次数", Value: "1", Placeholder: "每天最多可以获得多少次文档被收藏奖励，0表示无奖励。", InputType: InputTypeNumber, Sort: 60, Options: ""},
		{Category: ConfigCategoryScore, Name: ConfigScoreDocumentCommented, ColNum: 8, Label: "文档被评论", Value: "1", Placeholder: "上传的文档被评论后获得的积分", InputType: InputTypeNumber, Sort: 70, Options: ""},
		{Category: ConfigCategoryScore, Name: ConfigScoreDocumentCommentedLimit, ColNum: 16, Label: "每日文档被评论奖励次数", Value: "1", Placeholder: "每天最多可以获得多少次文档被评论奖励，0表示无奖励。", InputType: InputTypeNumber, Sort: 80, Options: ""},
		...
		// 展示配置
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayShowDocumentCount, ColNum: 8, Label: "是否显示文档数", Value: "true", Placeholder: "是否显示网站文档数", InputType: InputTypeSwitch, Sort: 0, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayShowDocumentDownloadCount, ColNum: 8, Label: "是否显示文档下载数", Value: "true", Placeholder: "是否显示文档被下载次数", InputType: InputTypeSwitch, Sort: 1, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayShowDocumentViewCount, ColNum: 8, Label: "是否显示文档浏览数", Value: "true", Placeholder: "是否显示文档被浏览次数", InputType: InputTypeSwitch, Sort: 2, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayShowDocumentFavoriteCount, ColNum: 8, Label: "是否显示文档收藏数", Value: "true", Placeholder: "是否显示文档被收藏次数", InputType: InputTypeSwitch, Sort: 3, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayShowRegisterUserCount, ColNum: 8, Label: "是否显示注册用户数", Value: "true", Placeholder: "网站首页，是否显示注册用户数", InputType: InputTypeSwitch, Sort: 10, Options: ""},
		...
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayHomeVersion, ColNum: 8, Label: "首页版本", Value: "v1", Placeholder: "默认为V1版，即旧版本", InputType: InputTypeSelect, Sort: 31, Options: "v1:V1版\nv2:V2版"},
		...
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayHideKeywordsOnLists, ColNum: 8, Label: "隐藏关键字", Value: "false", Placeholder: "文档列表页，是否隐藏右侧关键字", InputType: InputTypeSwitch, Sort: 70, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayHideCategoryWithontDocument, ColNum: 16, Label: "隐藏无文档分类", Value: "false", Placeholder: "对于分类下没有文档的分类，是否在前台页面进行隐藏", InputType: InputTypeSwitch, Sort: 80, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayWechatTip, ColNum: 24, Label: "微信/微信公众号提示文案", Value: "我们的公众号同样精彩", Placeholder: "全局右下角【固定栏】微信/微信公众号提示文案", InputType: InputTypeText, Sort: 100, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayWechatQRCode, ColNum: 24, Label: "微信/微信公众号二维码", Value: "", Placeholder: "全局右下角【固定栏】微信/微信公众号二维码图片。不存在则不显示", InputType: InputTypeImage, Sort: 110, Options: ""},
		{Category: ConfigCategoryDisplay, Name: ConfigDisplayContactTip, ColNum: 24, Label: "联系我们提示文案", Value: "联系我们，反馈您的意见与建议", Placeholder: "全局右下角【固定栏】联系我们的提示文案", InputType: InputTypeText, Sort: 120, Options: ""},
		...
		{Category: ConfigCategorySSR, Name: ConfigSSRCacheHome, ColNum: 12, Label: "首页缓存时间", Value: "1", Placeholder: "首页SSR缓存时间，单位为天，默认为1天。0表示不启动首页SSR", InputType: InputTypeNumber, Sort: 60, Options: ""},
		{Category: ConfigCategorySSR, Name: ConfigSSRCacheArticle, ColNum: 12, Label: "文章缓存时间", Value: "2", Placeholder: "文章SSR缓存时间，单位为天，默认为2天。0表示不启动文章页面SSR", InputType: InputTypeNumber, Sort: 70, Options: ""},
		{Category: ConfigCategorySSR, Name: ConfigSSRCacheDocument, ColNum: 12, Label: "文档缓存时间", Value: "2", Placeholder: "文档SSR缓存时间，单位为天，默认为2天。0表示不启动文档页面SSR", InputType: InputTypeNumber, Sort: 80, Options: ""},
		{Category: ConfigCategorySSR, Name: ConfigSSRCacheCategory, ColNum: 12, Label: "分类缓存时间", Value: "5", Placeholder: "分类SSR缓存时间，单位为天，默认为5天。0表示不启动分类页面SSR", InputType: InputTypeNumber, Sort: 90, Options: ""},
		{Category: ConfigCategorySSR, Name: ConfigSSRCacheUser, ColNum: 12, Label: "用户主页缓存时间", Value: "5", Placeholder: "用户主页缓存时间，单位为天，默认为5天。0表示不启动用户页面SSR", InputType: InputTypeNumber, Sort: 100, Options: ""},
		{Category: ConfigCategorySSR, Name: ConfigSSRCacheSearch, ColNum: 12, Label: "搜索结果缓存时间", Value: "7", Placeholder: "搜索结果缓存时间，单位为天，默认为7天。0表示不启动搜索结果页面SSR", InputType: InputTypeNumber, Sort: 110, Options: ""},
	}
