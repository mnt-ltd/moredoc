...
type Favorite struct {
	...
	UserId     int64     `form:"user_id" json:"user_id,omitempty" gorm:"column:user_id;type:bigint(20);size:20;default:0;comment:用户id;index:idx_user_id;index:idx_user_document_type,unique"`
	DocumentId int64     `form:"document_id" json:"document_id,omitempty" gorm:"column:document_id;type:bigint(20);size:20;default:0;comment:字段兼容，表示文档ID或者文章ID等;index:idx_user_document_type,unique"`
	Type       int32     `form:"type" json:"type,omitempty" gorm:"column:type;type:int(11);size:11;default:0;comment:收藏类型，0表示文档，1表示文章;index:idx_type;index:idx_user_document_type,unique"` // 枚举见 CategoryType
