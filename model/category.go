...
type Category struct {
	...
	Total           int        `form:"total" json:"total,omitempty" gorm:"column:total;type:int(11);size:11;default:0;comment:分类下的内容统计数据，doc_count字段后续将取消;"`
	Type            int        `form:"type" json:"type,omitempty" gorm:"column:type;type:tinyint(1);size:1;default:0;index:idx_type;comment:分类类型，0表示文档分类，2表示书籍分类，3表示文章分类"`
	UserId          int64      `form:"user_id" json:"user_id,omitempty" gorm:"column:user_id;type:int(11);size:11;default:0;comment:分类创建人ID;"`
	IP              string     `form:"ip" json:"ip,omitempty" gorm:"column:ip;type:varchar(64);size:64;comment:分类创建人IP;"`
