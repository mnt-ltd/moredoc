...
func request_DocumentAPI_UpdateDocumentContent_0(ctx context.Context, marshaler runtime.Marshaler, client DocumentAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Document
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateDocumentContent(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DocumentAPI_UpdateDocumentContent_0(ctx context.Context, marshaler runtime.Marshaler, server DocumentAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Document
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateDocumentContent(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDocumentAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DocumentAPIServer) error {
	...
	mux.Handle("PUT", pattern_DocumentAPI_UpdateDocumentContent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_DocumentAPI_UpdateDocumentContent_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_DocumentAPI_UpdateDocumentContent_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDocumentAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DocumentAPIClient) error {
	...
	mux.Handle("PUT", pattern_DocumentAPI_UpdateDocumentContent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DocumentAPI_UpdateDocumentContent_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DocumentAPI_UpdateDocumentContent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "document", "content"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_DocumentAPI_UpdateDocumentContent_0 = runtime.ForwardResponseMessage
